...
export function StatusBadge({
    ...
    const styles: Record<string, string> = {
        ...
        active: 'bg-[#E7F7EF] text-[#0CAF60]',
        started: 'bg-[#E7F7EF] text-[#0CAF60]',
        canceled: 'bg-[#FEECEE] text-[#EB3D4D]',
        "order-pending": 'bg-[#FFFAE7] text-[#F9C80E]',
        pass: 'bg-[#E9FAF7] text-[#22CAAD]',
        fail: 'bg-[#FEECEE] text-[#EB3D4D] ',
