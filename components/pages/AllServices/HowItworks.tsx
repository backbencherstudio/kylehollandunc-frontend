        ...
        <section className='relative overflow-hidden [background:var(--Gradient-2,linear-gradient(101deg,#023347_0.72%,#8099A3_114.82%))] px-6 sm:px-10 md:px-16 lg:px-[100px] xl:px-[140px] py-16 sm:py-20 lg:py-[120px] mx-auto'>
            ...
            <div className='max-w-[1320px] mx-auto relative z-50'>
                ...
                <div className='mb-14'>
                    ...
                    <SectionHeading className='max-w-[700px] text-white z-50 '>Simple process for Testing Services </SectionHeading>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                    ...
                    <StepCard
                        step={1}
                        title="Add to Cart"
                        description="Choose your required test and add it to your cart."
                    />

                    <StepCard
                        step={2}
                        title="Sample Details"
                        description="Submit sample information and confirm shipping details."
                    />

                    <StepCard
                        step={3}
                        title="Payment "
                        description="Readable summary + supporting detail, with an ID
for verification."
                    />
